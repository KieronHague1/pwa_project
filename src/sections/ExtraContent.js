...
import fishVideo from "../assets/videos/fish.mp4"; // Importing the first video asset
import mapVideo from "../assets/videos/map.mp4"; // Importing the second video asset
